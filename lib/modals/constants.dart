...
const String BMR_INFO =
    'BMR, or Basal Metabolic Rate, is the minimum amount of energy that an individual requires to sustain basic physiological functions at rest, such as breathing, circulation, and maintaining body temperature. It is essentially the number of calories that your body burns in a day, just by existing. BMR can vary depending on factors such as age, sex, weight, and height.\n\nFor men, the formula to calculate BMR is (10 * Weight In KG) + (6.25 * Height In CM) - (5 * Age) + 5. This formula takes into account the weight, height, and age of the individual, as well as the fact that men generally have a higher muscle mass and a faster metabolic rate than women. The additional 5 calories are added to account for the thermic effect of food, which is the energy required to digest and process food.\n\nFor women, the formula to calculate BMR is (10 * Weight In KG) + (6.25 * Height In CM) - (5 * Age) - 161. This formula is similar to the formula for men, but it takes into account that women generally have a higher body fat percentage and a slower metabolic rate than men. The subtracted 161 calories are to adjust for the lower metabolic rate of women compared to men.\n\nKnowing your BMR can be helpful for weight management, as it can give you an idea of how many calories you need to consume in a day to maintain your current weight, gain weight, or lose weight. To lose weight, you generally need to create a calorie deficit by consuming fewer calories than your BMR. Conversely, to gain weight, you need to consume more calories than your BMR.\n\nIn conclusion, BMR is the minimum amount of energy that your body requires to function at rest, and it can be calculated using specific formulas based on sex, weight, height, and age. Knowing your BMR can be useful for weight management and can help you make informed decisions about your diet and exercise routine.\n\n';

const String BMI_INFO =
    'BMI, or Body Mass Index, is a measure of body fat based on an individual\'s weight and height. It is a widely used tool to categorize individuals into different weight categories, ranging from underweight to obese. BMI is calculated by dividing an individual\'s weight in kilograms by the square of their height in meters.\n\nThe formula for calculating BMI is BMI = weightInKG / (heightInM * heightInM). The resulting value is then compared to standard BMI ranges to determine the weight category of the individual. A BMI value below 18.5 is considered underweight, while a BMI value between 18.5 and 24.9 is considered normal or healthy. A BMI value between 25 and 29.9 is considered overweight, and a BMI value of 30 or higher is considered obese.\n\nBMI is a useful tool for assessing an individual\'s weight status and can be used as a screening tool for health risks associated with being overweight or obese, such as heart disease, diabetes, and high blood pressure. However, it is important to note that BMI is not a perfect measure of body fat and can have limitations, especially for individuals who are highly muscular or have a high body fat percentage.\n\nTherefore, it is important to use BMI in conjunction with other measures, such as waist circumference and body fat percentage, to get a more accurate assessment of an individual\'s health status. Additionally, it is important to remember that BMI is just one factor to consider when evaluating overall health, and other lifestyle factors, such as diet and exercise, also play an important role in maintaining a healthy weight and reducing health risks associated with being overweight or obese.\n\nIn summary, BMI is a measure of body fat based on an individual\'s weight and height, and it can be used to categorize individuals into different weight categories. BMI is a useful tool for assessing an individual\'s weight status and can be used as a screening tool for health risks associated with being overweight or obese. However, it is important to use BMI in conjunction with other measures and lifestyle factors to get a more accurate assessment of overall health.\n\n';

const String IBW_INFO =
    'Ideal body weight (IBW) is a weight that is considered to be healthy for an individual based on their height and gender. IBW is often used as a reference point for weight management, especially for individuals who are trying to lose or gain weight. The formula for calculating IBW varies by gender.\n\nFor men, the formula to calculate IBW is 50 + (2.3 * Additional Height After 5ft). This formula takes into account that men generally have a higher muscle mass and bone density than women. To use this formula, first calculate the additional height above 5 feet by subtracting 5 from the individual\'s height in feet. Then, multiply this value by 2.3 and add 50 to get the ideal body weight for men.\n\nFor women, the formula to calculate IBW is 45.5 + (2.3 * Additional Height After 5ft). This formula takes into account that women generally have a higher body fat percentage and a lower muscle mass than men. To use this formula, first calculate the additional height above 5 feet by subtracting 5 from the individual\'s height in feet. Then, multiply this value by 2.3 and add 45.5 to get the ideal body weight for women.\n\nIt is important to note that IBW is just one reference point for weight management and should be used in conjunction with other measures, such as BMI and body fat percentage, to get a more accurate assessment of an individual\'s weight status. Additionally, it is important to remember that a healthy weight is not just about numbers, but also about overall health and wellbeing.\n\nIn conclusion, IBW is a weight that is considered to be healthy for an individual based on their height and gender. The formula for calculating IBW varies by gender and takes into account differences in muscle mass, bone density, and body fat percentage between men and women. However, IBW should be used in conjunction with other measures to get a more accurate assessment of an individual\'s weight status, and overall health and wellbeing should be the ultimate goal of any weight management plan.\n\n';

const String PRIVACY_POLICY =
    'Last updated: [01/03/2023]\n\nWe operate the HealthyU mobile application.\n\nThis page informs you of our policies regarding the collection, use and disclosure of Personal Information when you use our Service.\n\nWe will not use or share your information with anyone except as described in this Privacy Policy.\n\nWe use your Personal Information for providing and improving the Service. By using the Service, you agree to the collection and use of information in accordance with this policy.\n\nWe value your trust in providing us access to your information, thus we are striving to use commercially acceptable means of protecting them. But remember that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and we cannot guarantee its absolute security.\n\nWe may update our Privacy Policy from time to time. Thus, we advise you to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page.\n\n';

const String PHOTO_COMPARISON_BENEFITS =
    'Taking photos to track health progress is a great way to stay motivated and monitor progress over time. By visually tracking changes in body composition and overall health, individuals can gain a better understanding of their progress and adjust their diet and exercise routines accordingly.\n\nOne major benefit of taking photos to track health progress is that it provides a concrete and visual record of progress. As individuals embark on a health journey, it can be difficult to notice small changes over time. However, by taking regular photos, individuals can see the gradual changes that are taking place, which can be a major source of motivation and encouragement. Additionally, photos can provide insights into areas that may need further attention, such as stubborn areas of body fat that are not responding to diet and exercise.\n\nAnother benefit of using photos to track health progress is that it can be a great way to celebrate success. Whether an individual has lost weight, built muscle, or simply improved their overall health, being able to visually see the changes can be incredibly rewarding. This can help to reinforce positive behaviors and encourage continued progress.\n\nWhile there are many benefits to taking photos to track health progress, there are also some potential drawbacks to consider. One potential drawback is that it can be easy to become overly fixated on the visual changes that are taking place. While changes in body composition are important, it is also important to focus on overall health and wellness, including factors such as energy levels, mood, and overall quality of life. Additionally, individuals may feel self-conscious about taking photos, particularly in the early stages of their health journey. However, with time and practice, most individuals find that taking photos becomes a natural part of their routine and a valuable tool for tracking progress.\n\n';
